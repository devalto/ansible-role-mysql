...
[![Build Status](https://travis-ci.org/devalto/ansible-role-mysql.svg?branch=master)](https://travis-ci.org/devalto/ansible-role-mysql)

Installs and configures MySQL server on Ubuntu servers. Originally from https://github.com/geerlingguy/ansible-role-mysql
